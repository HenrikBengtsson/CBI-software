...
-- /usr/share/lmod/lmod/libexec/sh_to_modulefile /opt/rh/gcc-toolset-11/enable
setenv("INFOPATH","/opt/rh/gcc-toolset-11/root/usr/share/info")
prepend_path("LD_LIBRARY_PATH","/opt/rh/gcc-toolset-11/root/usr/lib64/dyninst")
prepend_path("LD_LIBRARY_PATH","/opt/rh/gcc-toolset-11/root/usr/lib")
prepend_path("LD_LIBRARY_PATH","/opt/rh/gcc-toolset-11/root/usr/lib64")
prepend_path("MANPATH","/opt/rh/gcc-toolset-11/root/usr/share/man")
prepend_path("PATH","/opt/rh/gcc-toolset-11/root/usr/bin")
setenv("PCP_DIR","/opt/rh/gcc-toolset-11/root")
setenv("PKG_CONFIG_PATH","/opt/rh/gcc-toolset-11/root/usr/lib64/pkgconfig")
